...
const {
  getUserById, createActivity, getPublicRoutinesByUser, getPublicRoutinesByActivity, getAllPublicRoutines, getRoutineById, createRoutine, getRoutineActivityById,
} = require('../db');
...
describe('API', () => {
  ...
  let routineActivityToCreateAndUpdate = {
    routineId: 4, activityId: 8, count: 20, duration: 300,
  };
  beforeAll(async () => {
    await rebuildDB();
  });
  ...
  describe('Users', () => {
    const newUser = { username: 'robert', password: 'bobbylong321' };
    const newUserShortPassword = { username: 'robertShort', password: 'bobby21' };
    describe('POST /users/register', () => {
      let tooShortSuccess; let
        tooShortResponse;
      beforeAll(async () => {
  ...
  describe('routine_activities', () => {
    const newRoutineActivityData = {
      routineId: 3, activityId: 8, count: 25, duration: 200,
    };
    describe('PATCH /routine_activities/:routineActivityId (**)', () => {
      ...
      it('Logged in user should be the owner of the modified object.', async () => {
        let respondedRoutineActivity; let
          errRespondedRoutineActivity;
        try {
